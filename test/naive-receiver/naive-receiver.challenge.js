...
describe('[Challenge] Naive receiver', function () {
    ...
    it('Exploit', async function () {
        ...
        console.log(await ethers.provider.getBalance(this.pool.address));       // 1000 ETH
        console.log(await ethers.provider.getBalance(this.receiver.address));   // 10 ETH
        console.log(await ethers.provider.getBalance(attacker.address));   // 10000 ETH
        ...
        console.log(await ethers.provider.getBalance(this.pool.address));       // 1000 ETH
        console.log(await ethers.provider.getBalance(this.receiver.address));   // 0 ETH
        console.log(await ethers.provider.getBalance(attacker.address));   // 10000 ETH
